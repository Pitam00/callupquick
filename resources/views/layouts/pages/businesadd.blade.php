                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            {{-- <div class="form-group">
                                                ...
                                                <select class="form-control select2-search" id="user_id" name="user_id" required>
                                                    <option value="">-- Select User --</option>
                                                    @foreach ($users as $user)
                                                        <option value="{{ $user->id }}"
                                                            {{ old('user_id', $business->user_id ?? null) == $user->id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group">
                                                <label for="user_id">Owner/User *</label>
                                                {{-- {{dd($users)}} --}}
                                                <select class="form-control select2-search" id="user_id"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control yearpicker"
                                                    id="establishment_year" name="establishment_year"
                                                    value="{{ $business->establishment_year ?? old("establishment_year") }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="ownership_type" name="ownership_type">
                                                    ...
                                                    <option value="sole_proprietorship"
                                                        {{ (isset($business) && $business->ownership_type == "sole_proprietorship") || old("ownership_type") == "sole_proprietorship" ? "selected" : "" }}>
                                                        Sole Proprietorship</option>
                                                    <option value="partnership"
                                                        {{ (isset($business) && $business->ownership_type == "partnership") || old("ownership_type") == "partnership" ? "selected" : "" }}>
                                                        Partnership</option>
                                                    <option value="corporation"
                                                        {{ (isset($business) && $business->ownership_type == "corporation") || old("ownership_type") == "corporation" ? "selected" : "" }}>
                                                        Corporation</option>
                                                    <option value="llc"
                                                        {{ (isset($business) && $business->ownership_type == "llc") || old("ownership_type") == "llc" ? "selected" : "" }}>
                                                        LLC</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if (isset($business) && $business->logo_url)
                                                    <div class="mb-3">
                                                        ...
                                                        <img src="{{ $business->logo_url }}" width="100"
                                                            class="img-thumbnail">
                                                        <div class="form-check mt-2">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="remove_logo" name="remove_logo">
                                                            <label class="form-check-label" for="remove_logo">Remove
                                                                current logo</label>
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                <small class="text-muted">Recommended size: 300x300px (PNG,
                                                    JPG)</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        {{ (isset($business) && $business->is_verified) || old("is_verified") ? "checked" : "" }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        id="is_claimed" name="is_claimed"
                                                        {{ (isset($business) && $business->is_claimed) || old("is_claimed") ? "checked" : "" }}>
                                                    <label class="custom-control-label"
                                                        for="is_claimed">Claimed</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="address_line1"
                                                    name="address_line1"
                                                    value="{{ $businessLocation->address_line1 ?? old("address_line1") }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="address_line2"
                                                    name="address_line2"
                                                    value="{{ $businessLocation->address_line2 ?? old("address_line2") }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="landmark"
                                                    name="landmark"
                                                    value="{{ $businessLocation->landmark ?? old("landmark") }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="postal_code"
                                                    name="postal_code"
                                                    value="{{ $businessLocation->postal_code ?? old("postal_code") }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        {{ (isset($businessLocation) && $businessLocation->is_primary) || old("is_primary") ? "checked" : "" }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="latitude"
                                                    name="latitude"
                                                    value="{{ $businessLocation->latitude ?? old("latitude") }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="longitude"
                                                    name="longitude"
                                                    value="{{ $businessLocation->longitude ?? old("longitude") }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <select class="form-control"
                                                                ...
                                                                required>
                                                                <option value="phone"
                                                                    {{ $contact->contact_type == "phone" ? "selected" : "" }}>
                                                                    Phone</option>
                                                                <option value="email"
                                                                    {{ $contact->contact_type == "email" ? "selected" : "" }}>
                                                                    Email</option>
                                                                <option value="fax"
                                                                    {{ $contact->contact_type == "fax" ? "selected" : "" }}>
                                                                    Fax</option>
                                                                <option value="whatsapp"
                                                                    {{ $contact->contact_type == "whatsapp" ? "selected" : "" }}>
                                                                    WhatsApp</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="form-row mt-2">
                                                        <div class="col-md-12">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label"
                                                                    for="contact_primary_{{ $index }}">Primary
                                                                    Contact</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        @else
                                            <div class="contact-item mb-3 p-3 border rounded">
                                                <div class="form-row">
                                                    <div class="col-md-4">
                                                        <label>Contact Type *</label>
                                                        <select class="form-control" name="contacts[0][contact_type]"
                                                            required>
                                                    ...
                                                    <div class="col-md-6">
                                                        <label>Contact Value *</label>
                                                        <input type="text" class="form-control"
                                                            name="contacts[0][contact_value]" required>
                                                    </div>
                                                    <div class="col-md-2 d-flex align-items-end">
                                                        <button type="button"
                                                            class="btn btn-sm btn-danger remove-contact-btn">
                                                ...
                                                <div class="form-row mt-2">
                                                    <div class="col-md-12">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label"
                                                                for="contact_primary_0">Primary Contact</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    <div id="hoursFields">
                                        ...
                                        @foreach ($days as $dayKey => $dayName)
                                            @php
                                                $hours = isset($businessHours)
                                                    ? $businessHours->firstWhere("day_of_week", $dayKey)
                                                    : null;
                                            @endphp
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($days as $dayKey => $dayName)
                                                    ...
                                                    <tr class="align-middle border-top">
                                                        <td class="font-weight-bold">{{ $dayName }}</td>
                                                        <td>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox"
                                                                    class="custom-control-input day-closed-toggle"
                                                                    id="closed_{{ $dayKey }}"
                                                                    name="hours[{{ $dayKey }}][is_closed]"
                                                                    {{ $hours && $hours->is_closed ? "checked" : "" }}>
                                                                <label class="custom-control-label"
                                                                    for="closed_{{ $dayKey }}"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="primary_category"
                                                    name="primary_category" required>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <div class="photo-thumbnail">
                                                        ...
                                                        <div class="photo-actions">
                                                            <button type="button"
                                                                class="btn btn-sm btn-danger delete-photo-btn"
...
<script>
    $(document).ready(function() {
        ...
        $('#businessForm').on('submit', function() {
            console.log('Submitting user_id:', $('#user_id').val());
        });
        ...
        $('#country').on('change', function() {
            ...
            $.get('/admin/get-states/' + countryId, function(data) {
        ...
        $('#state').on('change', function() {
            ...
            $.get('/admin/get-cities/' + stateId, function(data) {
